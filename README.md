...
| [docs/architecture/ai.md](docs/architecture/ai.md) | The AI provider seam, the job lifecycle and failure taxonomy, the RunPod deployment numbers, the in-app surface (cost, privacy, consent, BYOK) |
...
| [docs/authorisation-phase-16-3.md](docs/authorisation-phase-16-3.md) | Where authorisation lives once Supabase arrives, and what it costs |
...
| [docs/dashboard-acceptance-phase-13-5.md](docs/dashboard-acceptance-phase-13-5.md) | Acceptance criteria per section, keyboard and focus, announcements, i18n keys |
